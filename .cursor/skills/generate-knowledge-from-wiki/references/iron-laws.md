...
4d. **Zero-rule fake coverage banned**: confirmed slug with tagged sources but **zero** `### 规则` / `### Rule` in S7 → revert to **pending** or rewrite. Do not ship empty core-rules as committed briefs.
